...
<body>
    ...
    <h1 id='headerData'><a href="index.php"><ion-icon name="arrow-back-outline"></ion-icon></a>Insta Code<ion-icon style='opacity:0;' name="arrow-forward-outline"></ion-icon></h1>
    <form  method="post">
